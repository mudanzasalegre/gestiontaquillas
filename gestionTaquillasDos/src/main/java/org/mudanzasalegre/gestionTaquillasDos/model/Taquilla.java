...
@Entity
@Table(name = "taquillas", indexes = {
    @Index(name = "idx_taquilla_codigo", columnList = "codigoTaquilla")
})
public class Taquilla {
    ...
    public Taquilla(Vestuario vestuario, String codigoTaquilla, String nombreApellidos,
        ...
        this.empresaExterna = empresaExterna;
				...
				public String toString() {
					return "Taquilla [id=" + id + ", vestuario=" + vestuario + ", codigoTaquilla=" + codigoTaquilla
							+ ", nombreApellidos=" + nombreApellidos + ", categoriaProfesional=" + categoriaProfesional + ", servicio="
							+ servicio + ", telefono=" + telefono + ", empresaExterna=" + empresaExterna + "]";
				}
