...
public class TaquillaService {
    ...
    public List<Taquilla> findAll(Sort sort) {
        return taquillaRepository.findAll(sort);
    }
    ...
    public List<Taquilla> findByVestuarioId(Integer vestuarioId, Sort sort) {
        return taquillaRepository.findByVestuarioId(vestuarioId, sort);
    }
